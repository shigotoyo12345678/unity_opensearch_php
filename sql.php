...
$tel = $_POST["tel"];               //電話番号
/*
$a = $_SESSION["THOH"] . ":" . $_SESSION["THOM"];             //通常開店時間（平日）
$b = $_SESSION["THCH"] . ":" . $_SESSION["THCM"];             //通常閉店時間（平日）
$c = $_SESSION["TYOH"] . ":" . $_SESSION["TYOM"];             //通常開店時間（土日祝）
$d = $_SESSION["TYCH"] . ":" . $_SESSION["TYCM"];             //通常閉店時間（土日祝）*/
